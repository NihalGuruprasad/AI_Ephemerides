...
sun = ephemeris['sun']
jupiter = ephemeris['jupiter barycenter']  # Direct reference to Mercury's data
...
result = minimize(total_distance_jupiter, start_jd, bounds=[(min_jd, max_jd)], method='L-BFGS-B')
